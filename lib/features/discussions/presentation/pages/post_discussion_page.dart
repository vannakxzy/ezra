...
import '../bloc/bloc/post_discussion_bloc.dart';

@RoutePage()
class PostDiscussionPage extends StatefulWidget {
  final BandEntity band;
  const PostDiscussionPage({super.key, required this.band});

  @override
  State<PostDiscussionPage> createState() => _PostDiscussionPageState();
}

class _PostDiscussionPageState
    extends BasePageBlocState<PostDiscussionPage, PostDiscussionBloc> {
  ...
  Widget buildPage(BuildContext context) {
    ...
    return BlocBuilder<PostDiscussionBloc, PostDiscussionState>(
      builder: (context, state) {
        return GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              title: Text(t.post.createDiscussion),
              leading: IconButton(
                onPressed: () {
