...
class ConfirmDeleteAnswerAlert extends StatefulWidget {
  const ConfirmDeleteAnswerAlert({
    super.key,
  });
  ...
  static Future<bool> show({
    required BuildContext context,
      ...
      await showDialog(
        context: context,
        builder: (_) => const ConfirmDeleteAnswerAlert(),
      );

  @override
  State<ConfirmDeleteAnswerAlert> createState() =>
      _ConfirmDeleteAnswerAlertState();
}

class _ConfirmDeleteAnswerAlertState extends State<ConfirmDeleteAnswerAlert> {
  @override
  void initState() {
    super.initState();
  }
