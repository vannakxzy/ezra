...
import 'bloc/edit_question_bloc.dart';
...
class _EditQuestionPageState
    extends BasePageBlocState<EditQuestionPage, EditQuestionBloc> {
  ...
  Widget buildPage(BuildContext context) {
    ...
    return BlocBuilder<EditQuestionBloc, EditQuestionState>(
