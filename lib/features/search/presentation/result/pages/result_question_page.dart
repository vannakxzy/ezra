...
class ResultQuestionPage extends StatefulWidget {
  final String text;
  const ResultQuestionPage({super.key, required this.text});
  @override
  State<ResultQuestionPage> createState() => _ResultQuestionPageState();
}

class _ResultQuestionPageState
    extends BasePageBlocState<ResultQuestionPage, ResultQuestionBloc> {
  @override
  ...
  Widget buildPage(BuildContext context) {
    return BlocBuilder<ResultQuestionBloc, ResultQuestionState>(
      builder: (context, state) {
        if (state.loaingQuestion && state.questions.isEmpty) {
          return SingleChildScrollView(child: HomeShimmer());
        }
