...
@Injectable()
class ApproveUserInbandUsecase implements BaseUseCase<BandIdUserIdInput, void> {
  final BandRepository _repository;

  ApproveUserInbandUsecase(this._repository);

  @override
  Future<void> excecute(BandIdUserIdInput input) async {
    await _repository.approveUserInband(input);
  }
}
