...
@Injectable()
class RemovebandMemberUsecase implements BaseUseCase<BandIdUserIdInput, void> {
  final BandRepository _repository;

  RemovebandMemberUsecase(this._repository);

  @override
  Future<void> excecute(BandIdUserIdInput input) async {
    await _repository.removeMemberband(input);
  }
}
