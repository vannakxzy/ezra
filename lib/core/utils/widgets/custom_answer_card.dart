...
class CustomAnswerCrad extends StatefulWidget {
  ...
  @override
  State<CustomAnswerCrad> createState() => _CustomAnswerCradState();
}

class _CustomAnswerCradState extends State<CustomAnswerCrad> {
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      kPadding2.gap,
                                      if (!widget.isCommnity)
                                        GestureDetector(
                                            onTap: () {
                                              if (widget.isYourQuestion) {
                                                widget
                                                    .action(answerEnum.correct);
                                              }
                                            },
                                            child:
                                                widget.answertEntity.is_correct
                                                    ? SvgPicture.asset(
                                                        height: 14,
                                                        width: 14,
